...
namespace Inicio
{
    public partial class frmConsultDinheiro : Form
    {
        //DEFINE STRING
        ...
        void fill_listbox()
        {
            ...
            string Query = "select * from consultardinheiro ;";
            ...
            try
            {
                ...
                while (myReader.Read())
                {
                    ...
                    listBox1.Items.Add(name + ' ' + cpf + ' ' + email + ' ' + valor + ' ' + ' ' + data);
                }
            }
            catch (Exception ex)
            {
        ...
        private void bunifuImageButton1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Cadastro realizado com sucesso.", "RRAN - Planilha.", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void retrieve()
        {
            ...
            cmd.CommandText = "SELECT * FROM consultardinheiro";
        ...
        {
            string constring = "datasource=sql130.main-hosting.eu;database=u877132465_micro;username=u877132465_micro;password=91893409";
            string Query = "select * from consultardinheiro where nm_name='" + listBox1.Text + "' ;";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);
            MySqlDataReader myReader;
